              ...
              <div class="d-flex">
                <div class="mb-2">
                  <input class="form-check-input" <?php if ($gender->id === $student->gender_id) {
                                                    echo "checked";
                                                  } ?> type="radio" name="gender" id="<?php echo $gender->gender_name ?>" value="<?php echo $gender->id ?>">
              ...
              <div class="d-flex">
                <div class="mb-2">
                  <input class="form-check-input" <?php if ($course->id === $student->course_id) {
                                                    echo "checked";
                                                  } ?> type="radio" name="course" id="<?php echo $course->course_name ?>" value="<?php echo $course->id ?>">
