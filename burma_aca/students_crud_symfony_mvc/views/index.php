            ...
            <?php foreach ($students as $student) : ?>
              <tr>
                ...
                <td class="d-flex gap-2">
                  <a class="btn btn-primary btn-sm text-white text-decoration-none" href="/student/<?php echo $student->id ?>">Details</a>
                  <a class="btn btn-info btn-sm text-white text-decoration-none" href="/students/edit/<?php echo $student->id ?>">Edit</a>
                  <a class="btn btn-outline-danger btn-sm" href="/students/destroy/<?php echo $student->id ?>">Delete</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
