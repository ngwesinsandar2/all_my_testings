  ...
  <div class="container py-3 d-flex flex-column align-items-center">
    <div>
      ...
      <div class="d-flex gap-4">
        ...
        <a class="btn btn-info text-white text-decoration-none" href="/students/edit/<?php echo $student->id ?>">Edit</a>
        <a class="btn btn-outline-danger" href="/students/destroy/<?php echo $student->id ?>">Delete</a>
      </div>
    </div>
  </div>
</body>
